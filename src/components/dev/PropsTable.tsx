        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-light-gray bg-off-white">
              <th className="px-6 py-3 text-left text-small font-semibold text-off-black">Name</th>
              <th className="px-6 py-3 text-left text-small font-semibold text-off-black">Type</th>
          ...
          <tbody className="bg-white">
            {props.map((prop, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <code className="font-mono text-small text-primary">{prop.type}</code>
                  {prop.options && (
                    <div className="mt-1">
                        ...
                        <div className="mt-1 space-y-1">
                          {prop.options.map((option) => (
                            <div key={option} className="text-warm-gray">
                              <code className="rounded bg-light-gray px-1">
                                &quot;{option}&quot;
                              </code>
                            </div>
                          ))}
                ...
                <td className="px-6 py-4">
                  <p className="text-small leading-relaxed text-warm-gray">{prop.description}</p>
                </td>
              </tr>
            ))}
          </tbody>
          ...
          <div key={component.name} className="rounded-lg border border-light-gray p-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {component.keyProps.map((prop) => (
                <code
                  key={prop}
                  className="rounded bg-primary/10 px-2 py-1 text-small text-primary"
                >
                  {prop}
                </code>
              ))}
