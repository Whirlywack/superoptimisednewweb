...
export function ResponsiveCardGrid({
  ...
  return (
    <div
      className={cn("grid w-full", gapVariants[gap], className)}
      style={{
  ...
  return (
    ...
    >
      ...
      {React.Children.map(children, (child, index) => (
        <div key={index} className="break-inside-avoid" style={{ marginBottom: gapValue }}>
          {child}
        </div>
      ))}
    </div>
...
export function ResponsiveLayout({
  ...
  if (variant === "grid") {
    const cols: { mobile: 1 | 2; tablet: 1 | 2 | 3 | 4; desktop: 1 | 2 | 3 | 4 | 5 | 6 } =
      breakpoint === "mobile"
  ...
  if (variant === "stack") {
    const direction =
      breakpoint === "mobile" ? "column" : breakpoint === "tablet" ? "row-tablet" : "row-desktop";
  ...
  if (variant === "masonry") {
    const cols: { mobile: 1 | 2; tablet: 1 | 2 | 3; desktop: 1 | 2 | 3 | 4 } =
      breakpoint === "mobile"
        ? { mobile: 1, tablet: 1, desktop: 2 }
        : breakpoint === "tablet"
          ? { mobile: 1, tablet: 2, desktop: 3 }
