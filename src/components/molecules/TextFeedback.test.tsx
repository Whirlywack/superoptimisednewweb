...
describe("TextFeedback", () => {
  ...
  it("renders description when provided", () => {
    render(<TextFeedback {...defaultProps} description="Please provide detailed feedback" />);
  ...
  it("renders textarea with correct attributes", () => {
    render(
      <TextFeedback {...defaultProps} placeholder="Enter your feedback" rows={6} maxLength={500} />
    );
  ...
  it("calls onChange when text is entered", async () => {
    ...
    expect(mockOnChange).toHaveBeenLastCalledWith("Test feedback");
  });
  ...
  it("shows character count when maxLength is set", () => {
    render(<TextFeedback {...defaultProps} value="Test" maxLength={100} />);

    expect(screen.getByText("4/100")).toBeInTheDocument();
  });

  it("updates character count as user types", async () => {
    render(<TextFeedback {...defaultProps} maxLength={100} value="Hello" />);
  ...
  it("prevents typing beyond maxLength", async () => {
    ...
    render(<TextFeedback {...defaultProps} onChange={mockOnChange} maxLength={5} />);
  ...
  it("shows validation error when provided", () => {
    render(<TextFeedback {...defaultProps} error="This field is required" />);
  ...
  it("shows minimum length warning", () => {
    render(<TextFeedback {...defaultProps} value="Short" minLength={10} />);
  ...
  it("shows helper text when provided and no error", () => {
    render(<TextFeedback {...defaultProps} helperText="This is helpful information" />);
  ...
  it("handles paste operations within character limit", async () => {
    ...
    render(<TextFeedback {...defaultProps} onChange={mockOnChange} maxLength={10} value="" />);
