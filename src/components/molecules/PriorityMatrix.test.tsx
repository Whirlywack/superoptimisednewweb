...
describe("PriorityMatrix", () => {
  ...
  it("renders description when provided", () => {
    render(
      <PriorityMatrix {...defaultProps} description="Drag tasks into the appropriate quadrants" />
    );
  ...
  it("shows progress when requireAllItems is true", () => {
    ...
    render(<PriorityMatrix {...defaultProps} value={value} requireAllItems />);
  ...
  it("shows validation error when provided", () => {
    render(<PriorityMatrix {...defaultProps} error="Please place at least one item" />);
  ...
  it("shows warning when requireAllItems is true and items are unplaced", () => {
    render(<PriorityMatrix {...defaultProps} requireAllItems value={[]} />);

    expect(screen.getByTestId("validation-warning")).toBeInTheDocument();
    expect(
      screen.getByText("Please place all items in the matrix to continue.")
    ).toBeInTheDocument();
  });
  ...
  it("shows helper text when provided", () => {
    render(<PriorityMatrix {...defaultProps} helperText="Drag items to prioritize them" />);

    expect(screen.getByText("Drag items to prioritize them")).toBeInTheDocument();
  });

  it("hides helper text when error is present", () => {
    render(<PriorityMatrix {...defaultProps} helperText="Helper text" error="Error message" />);
