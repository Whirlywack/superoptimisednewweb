        ...
        <div className="mx-auto max-w-2xl px-4">
          ...
          <div className="mb-8 rounded-lg border border-light-gray bg-white p-6">
            ...
            <div className="space-y-3 text-warm-gray">
              <p>
                This is likely a temporary issue with our servers. Your XP record 
                is secure and hasn't been lost.
              </p>
              <p>
                You can try again in a few minutes, or contact support if the 
                problem persists.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 rounded border-l-4 border-primary/20 bg-primary/5 p-4">
            <p className="text-sm text-warm-gray">
              <strong>Error Code:</strong> XP_CLAIM_ERROR<br />
