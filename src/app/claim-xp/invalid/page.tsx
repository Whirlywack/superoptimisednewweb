      ...
      <main className="flex-1 py-16">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="mb-4 text-3xl font-bold text-off-black">Invalid or Expired Link</h1>
          ...
          <div className="mb-8 rounded-lg border border-light-gray bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold text-off-black">What might have happened?</h2>
          ...
          {/* Actions */}
          <div className="mb-8 rounded-lg border border-light-gray bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold text-off-black">What you can do</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-warm-gray">
                    Look for the most recent XP claim email and use that link. Check your spam
                    folder too.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-warm-gray">
                    Go back to the voting page and try claiming your XP again if the link has
                    expired.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 rounded border-l-4 border-primary/20 bg-primary/5 p-4">
            <p className="text-sm text-warm-gray">
              <strong>Need help?</strong> If you continue having issues claiming your XP, reach out
              on X (@superoptimised) and we&apos;ll help you resolve it.
            </p>
          </div>
        </div>
      </main>
